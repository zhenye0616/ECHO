...
Materialize the reviewed item-132 product closure as a source-independent local `echo-brain` repository. Judge the final repo and evidence; do not build a reusable migration controller.
...
- Do not create a target remote, publish, deploy, or advance maturity.
- Do not implement rank 2/rank 3 features, org context, delivery, or launchd.
- Do not modify/freeze current product paths, live state, credentials, wiki, holdout-131, or sibling targets.
