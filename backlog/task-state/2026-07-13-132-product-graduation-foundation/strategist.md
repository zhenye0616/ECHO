...
- Cross-vendor reviewers must ratify that the file-level source allowlist is narrow enough to enforce T1 while still permitting the existing storage/logging primitives the wedge requires.
