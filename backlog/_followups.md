...
- 2026-07-13 (founder topology supersession): create three source-independent local repositories before remote publication or FOUNDER LIVE — client product `echo-brain`, internal orchestration `echo-loop`, and context capture/retrieval `echo-context`; keep Project_echo as pinned migration source/backup during parity, then transfer authority per repo only through a later founder checkpoint. → SPECCED as `backlog/proposed/2026-07-13-133-local-echo-brain-source-extraction.md`, `backlog/proposed/2026-07-13-134-local-echo-loop-source-extraction.md`, and `backlog/proposed/2026-07-13-135-local-echo-context-source-extraction.md`. The context authority leg is now SPECCED across completed 136, `backlog/proposed/2026-07-15-137a-echo-context-candidate-runtime.md`, `backlog/proposed/2026-07-15-137b-echo-context-real-shadow-install.md`, and `backlog/proposed/2026-07-15-138-echo-context-cutover-substrate-rehearsal.md`; the cancelled monolithic 137 and historical 139 remain risk evidence, and brain/loop authority legs remain open.
...
- 2026-07-15 (from 135 merge): before qualification, explicitly adjudicate residual onboarding/task-state and coordination vocabulary, Project_echo default-path semantics, and loopback authentication/exposure policy; these do not block repository merge at DEV. → SPECCED across completed 136, `backlog/proposed/2026-07-15-137a-echo-context-candidate-runtime.md`, `backlog/proposed/2026-07-15-137b-echo-context-real-shadow-install.md`, and `backlog/proposed/2026-07-15-138-echo-context-cutover-substrate-rehearsal.md`; the cancelled monolithic 137 and historical 139 remain immutable risk evidence.
