...
round: 2
spec_commit_sha: 55f9adebc54cd77f95265b8da2c6ca6ae7886d07
artifact_path: backlog/proposed/2026-07-15-137a-echo-context-candidate-runtime.md
class: structural-reform
requested_at: '2026-07-17T21:13:24Z'
requested_reviewers:
- codex
- codex-ops
correlation_id: 9c7b1bdf-01ad-4183-8e5a-138ea393e1cc
focus_hints: Delta-verify all nine R1 families against the closed command/topology/auth/inventory/lease/outer-observer/socket-drain/sandbox
  patch; reject any reintroduction of install, fixed-path, portable-artifact, or second
  restart authority.
review_protocol: 2
review_mode: delta
review_counter:
...
- family_id: fam-e9ae0e92ef54305d
  ...
  reviewers:
  - codex
baseline_spec_sha: de3c249f8a586b2723616f010d6aab2586629744
---

# What to review

Read `backlog/proposed/2026-07-15-137a-echo-context-candidate-runtime.md` at commit `55f9adebc54cd77f95265b8da2c6ca6ae7886d07`. Apply the canonical reviewer
loop (see `.claude/commands/review-queue-<reviewer>.md`). Embed any
prior-round context inline below; do not rely on out-of-band atom
lookups for the review itself.

Protocol v2 mode: `delta`; lifetime round `2`; epoch `1` round `2`. Treat the embedded family and proof context as the complete cross-round review lens.
