...
|---|---|---|---|---|---|
| 1 | MEDIUM | codex | AC4 queue-errors append + combine.py git path | _strategist fills_ | _strategist fills_ |
| 2 | LOW | codex | Frontmatter spec_refs and Out of Scope vs AC3 | _strategist fills_ | _strategist fills_ |
