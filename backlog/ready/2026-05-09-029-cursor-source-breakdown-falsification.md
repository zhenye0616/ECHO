...
agent_notes: ""
review_notes: ""
resume_tail_source: "fs:/Users/zhenye/.claude/projects/-Users-zhenye-Desktop-Project-echo/71b36548-cf1d-4fe5-9370-b0317f9c4ac0.jsonl"
recommended_claimer: "Cursor's Claude (Agent mode required — Ask mode cannot run MCP tools per Cursor product behavior). The diagnostic phase requires live ECHO MCP calls + live Cursor SQLite probes, both of which Cursor's Claude in Agent mode is uniquely well-positioned to run against its own active session."
spec_refs:
  - src/trace/index.ts
