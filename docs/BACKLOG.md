...
|---|---|---|---|---|
| HIGH | [2026-05-10-032-m2-first-call-reliability](../backlog/ready/2026-05-10-032-m2-first-call-reliability.md) | M2 first-call reliability — strict-partition single-source-recent demotion + resume-friendly `get_atoms` ordering | 0.5-1d | 3 cross-tool review rounds (R1: 9 findings, R2: 3, R3: 3); both reviewers converged on "Proceed." In-flight as of 2026-05-10. Unblocks the hotkey-overlay vertical slice (separate item, not yet specced). Item 031 (`get_recent_work_context` deprecation) sequenced AFTER this lands + ≥1 week dogfooding. |
| HIGH | [2026-05-10-033-full-atom-recovery](../backlog/ready/2026-05-10-033-full-atom-recovery.md) | Full-atom recovery — `get_atom(id)` verbatim escape hatch (M1-3 Magic Moment) | 0.5-1d | Closes the long-turn elision recovery path in-MCP (today: JSONL fallback). 4 M1-3 incidents in 24h on long Codex review turns; cross-tool review pattern is structurally dependent on this. Codex pushback #5 (2026-05-10 14:50 PDT) endorsed as a small separate item. First spec authored with the strategist 4-gate self-review checklist applied pre-commit. Tool count: 7 → 8. Can claim in parallel with 032. |
