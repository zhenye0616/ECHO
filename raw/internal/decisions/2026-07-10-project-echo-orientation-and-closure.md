...
| A6 | Public history and customer-data handling | Exposure remediated/scanned; Job C rewrite deferred; branch CI green; GitHub controls verified red | Scan report + data/retention/deletion/custody decision | Founder + security executor | pending | Job C deferred in `2026-07-11-filter-repo-decision-template.md`; GitHub audit `2026-07-12-github-security-readonly-audit.md`; awaits remediation/risk disposition + first post-merge `main` run |
