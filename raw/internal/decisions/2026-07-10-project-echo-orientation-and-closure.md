...
| A6 | Public history and customer-data handling | Exposure known; scan/policy open | Scan report + data/retention/deletion/custody decision | Founder + security executor | pending | — |
