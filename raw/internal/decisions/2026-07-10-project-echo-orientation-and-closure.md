...
| A6 | Public history and customer-data handling | Exposure remediated/scanned; Job C rewrite deferred; GitHub evidence open | Scan report + data/retention/deletion/custody decision | Founder + security executor | pending | Job C `deferred-with-owner-and-trigger` in `2026-07-11-filter-repo-decision-template.md`; A6 awaits GitHub settings evidence/deferral + first landed CI run |
