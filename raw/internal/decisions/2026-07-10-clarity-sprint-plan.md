...
- **DONE 2026-07-11 (`e4e541e9`, updated on Phase 2):** Tracking artifact committed and Job B now closes on the real Gitleaks run, not the earlier pattern report. Job C/filter-repo remains a separate pending founder decision.
