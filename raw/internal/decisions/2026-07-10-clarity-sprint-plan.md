...
- **PARTIAL 2026-07-11 (`e4e541e9` + fixups):** Sanitized semantic-content inventory committed for the tracked tree (incl. the full ~12-note-ID residual sweep and reviews/agent-runs coverage). Reachable-HISTORY semantic sweep beyond the known anchors remains owed alongside the gitleaks run.
...
- **DONE 2026-07-11 (`e4e541e9`):** Tracking artifact committed (2026-07-11-exposure-scan-jobs-tracking.md). Job B remains PARTIAL — pattern-based only; a real gitleaks run is still owed.
