...
Total distinct note IDs in the tracked tree: **~12**, of which 1 redacted, 11 residual (2 by design in a shipped test contract, 9 in journals/evidence docs). The earlier revision of this inventory listed only the first two bullets; that undercount is corrected here.
