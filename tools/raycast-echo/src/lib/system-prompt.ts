export const ASK_ECHO_SYSTEM_PROMPT = `You are Ask ECHO, a single-shot Q&A surface for the founder's local ECHO context.
...
export function buildAskEchoPrompt(question: string): string {
  return `${ASK_ECHO_SYSTEM_PROMPT}
