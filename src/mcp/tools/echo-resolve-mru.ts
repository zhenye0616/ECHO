...
export const ECHO_RESOLVE_MRU_DESCRIPTION =
  ...
  '      • Source-app name (`cursor` | `claude_code` | `codex` | `git`) → PREFIX MATCH on the canonical app prefix; resolves to the newest non-fs source under that prefix.\n' +
